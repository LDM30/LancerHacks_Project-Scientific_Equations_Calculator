...
def ptheorem():
    ...
    def calculate():
        ...
        if(variablea == "Unknown Variable" and variableb != "Unknown Variable" and variablec != "Unknown Variable"):
            ...
            test = float(csquared-bsquared)
            if(test < 0):
                messagebox.showerror("Error!", "Cannot take the square root of a negative number. Check your variables.")
                playsound("error_jingle.mp3")
            ...
            test = float(csquared - asquared)
            if (test < 0):
                messagebox.showerror("Error!", "Cannot take the square root of a negative number. Check you variables.")
                playsound("error_jingle.mp3")
    ...
    global pythhome
    pythhome = Tk()
    pythhome.title("Pythagorean Theorem Calculator")
...
def phcalculator():
    ...
    equation = Label(phhome, text="pH = -log [H\u207a]")
    equation.grid(row=3, column=0)
...
def pohcalculator():
    ...
    equation = Label(pohhome, text="pOH = -log [OH\u207b]")
    equation.grid(row=3, column=0)
...
def consolecalculator():
    ...
    def gottaGoFast():
        ...
        if (select == "s" or select == "S"):
            ...
            if (select1 == "v" or select == "V"):
                print("Solving for speed.")
                bulk = float(input("Input bulk modulus"))
                dens = float(input("Input density (kg/m^3)"))
                ans = sqrt(bulk / dens)
                print("Answer: ", ans, " m/s")
            elif (select1 == "b" or select == "B"):
                print("Solving for bulk modulus.")
                sanic = float(input("Input speed of sound (m/s)"))
                dens = float(input("Input density (kg/m^3)"))
                ans = ((sanic ** 2) / dens)
                print("Answer: ", ans)
            elif (select1 == "p" or select == "P"):
                print("Solving for density.")
                bulk = float(input("Input bulk modulus"))
                sanic = float(input("Input speed of sound (m/s)"))
                ans = (bulk / (sanic ** 2))
    ...
    def start():
        ...
        if (initial == "1"):
            ...
            print("hmmmm... You're number was not found. Please try again...")
            start()
...
pythagorean = Button(main, text="Pythagorean Theorem Calculator", command=ptheorem)
pythagorean.pack()
